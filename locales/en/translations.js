export const TRANSLATION_EN = {
  ...
  /* Orders - Comments */
  commentsSupportContact: 'Questions & Replies About This Product',
  ...
  /* Product Management */
  pmCategoryRemovedSuccessfully: 'The selected record has been removed.',
  pmErrorRemovingCategory: 'Error trying to remove the selected category.',
  pmOperationCancelCategory: 'Operation Canceled',
  pmRemoveCategoryDialog: 'Do you want to delete this category?',
  pmRemoveCategoryDialogTitle: 'Delete Confirmation',
  pmCategoryAddedSuccessfully: 'The new category was added successfully.',
  pmCategoryTitleAddedSuccessfully: 'Confirmed',
  pmCategoryTitleAddError: 'Error',
  pmCategoryTitleAddRejected: 'Rejected',
  pmCategoryTitle: 'Categories',
  pmCategoryLabelTitle: 'Title',
  ...
  pmProductTitleRejected: 'Rejected',
  pmProductErrorRemoving: 'Error trying to remove the selected product.',
  pmProductOperationCancel: 'Operation Canceled.',
