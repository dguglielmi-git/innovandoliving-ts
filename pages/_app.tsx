...
import { getCart, cleanCart, addToCart, removeItemCart, countProductsCart } from '../api/cart';
...
export default function MyApp({ Component, pageProps }) {
  ...
  const setOrderCounters = async () => {
    const { queryCounter: qCounter = 0, ordersCounter: oCounter = 0 } = (await getUnreadMsgs()) || {};
