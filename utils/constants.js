...
export const DEFAULT_SORT_PRODUCT_ITEMS = 'sort=createAt:-1&publish=true&limit='
...
export const LINK_TO_PRODUCT_MGMT = '/productmanagement'
...
export const ERROR_GETTING_DOCTYPES =
  'Error trying to get documents from the backend.'
