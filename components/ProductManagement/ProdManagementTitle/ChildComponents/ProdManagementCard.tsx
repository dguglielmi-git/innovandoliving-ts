...
import { ProductManagementProps } from '../../types/ProductManagementProps'

const ProdManagementCard: React.FC<ProductManagementProps> = ({
  icon,
  label,
  value,
  iconColor = 'gray'
...
export default ProdManagementCard
