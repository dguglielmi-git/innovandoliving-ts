...
import CustomInputCalendar from '@/components/Common/CustonInputCalendar/CustomInputCalendar';
    ...
    <section className='add-edit-product-details'>
      ...
      <section className='add-edit-product-details__form'>
        ...
        <CustomInput
          ...
          onChange={formik.handleChange}
        />
        <CustomInput label='Category' placeholder='Category' name='productCategory' onChange={formik.handleChange} />
