...
export default function SystemSettings (props) {
  ...
  const formik = useFormik({
    initialValues: initialValues(
      ...
      configs?.external_provider_price
    ),
    ...
    <div className='system-settings'>
      ...
      <Form onSubmit={formik.handleSubmit}>
        ...
        <Form.Input
          ...
          onChange={formik.handleChange}
        />
        <Label>{t('systemSettingsExternalProviderPrice')}</Label>
        <Form.Input
          name='external_provider_price'
          placeholder={t('systemSettingsExternalProviderPricePlaceholder')}
          value={formik.values.external_provider_price}
          error={formik.errors.external_provider_price}
          onChange={formik.handleChange}
        />
...
function initialValues (
  addressDeliveryCenter,
  minimumKm,
  kmPrice,
  externalProviderPrice
) {
  return {
    address_delivery_center: addressDeliveryCenter || '',
    km_minimum: minimumKm || '',
    km_price: kmPrice || '',
    external_provider_price: externalProviderPrice || ''
  }
}
